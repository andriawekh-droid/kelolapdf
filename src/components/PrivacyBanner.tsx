...
export const PrivacyBanner: React.FC = () => {
  return (
    ...
    >
      {/* Decorative Notion-style doodle / emoji in corner */}
      <div className="absolute top-3 right-4 text-3xl opacity-30 select-none hidden sm:block">
        🔒✨
      </div>
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-5">
        ...
        <div className="flex-1 space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline-flex px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-emerald-100 text-emerald-800 rounded-full border border-emerald-300">
              100% Client-Side
            </span>
          </div>
